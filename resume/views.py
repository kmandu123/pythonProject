...
from resume.models import Comm_div, Comm_code, Employee
...
def CreateComm(request):
    ...
    # detail form 객체 생성
    Comm_codeFormset = inlineformset_factory(Comm_div, Comm_code, fields=('comm_code', 'comm_div_id', 'comm_code_name', 'ref_field', 'display_order', 'use_yn', 'summary'),
                                        widgets={'summary': forms.TextInput(attrs={'size': 70}), 'display_order': forms.TextInput(attrs={'size': 3})}, extra=1, can_delete=True)
